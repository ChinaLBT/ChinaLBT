<script type="text/javascript" src="<?=$webRoot?>/static/js/jquery.min.js?v=2.1.4"></script>
<script type="text/javascript" src="<?=$webRoot?>/static/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?=$webRoot?>/static/js/main.js"></script>
<script type="text/javascript" src="<?=$webRoot?>/static/js/content.js"></script>
<script type="text/javascript" src="<?=$webRoot?>/static/js/hAdmin.js"></script>
